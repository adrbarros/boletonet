...
[assembly: WebResource("BoletoNet.Imagens.133.jpg", "image/jpg")]

namespace BoletoNet
{
    internal class Banco_Cresol : AbstractBanco, IBanco
    {
        private string _dacNossoNumero = string.Empty;
        private int _dacBoleto = 0;

        internal Banco_Cresol()
        {
            this.Codigo = 133;
            this.Digito = "2";
            this.Nome = "Cresol";
        ...
        {
            return Mod11Cresol(boleto.Carteira + Utils.FitStringLength(boleto.NossoNumero, 11, 11, '0', 0, true, true, true), 7);
        }
        ...
        private string Mod11Cresol(string seq, int b)
        {
        ...
        public string GerarDetalheRemessaCNAB400(Boleto boleto, int numeroRegistro, TipoArquivo tipoArquivo)
        {
            try
            {
                ...
                _detalhe += Mod11Cresol(boleto.Carteira + Utils.FitStringLength(boleto.NossoNumero, 11, 11, '0', 0, true, true, true), 7); // Digito de Auto Conferencia do Nosso Número (01)
                ...
                */
                ...
                {
                    switch ((EnumInstrucoes_Cresol)instrucao.Codigo)
                    {
        ...
        public string GerarRegistroDetalhe2(Boleto boleto, int numeroRegistro)
        {
            ...
            // Força o NossoNumero a ter 11 dígitos. Alterado por Luiz Ponce 07/07/2012
            _detalhe += Mod11Cresol(boleto.Carteira + Utils.FitStringLength(boleto.NossoNumero, 11, 11, '0', 0, true, true, true), 7); // 394 a 394 Digito de Auto Conferencia do Nosso Número (01)
            //Desconto Bonificação por dia (10, N)
