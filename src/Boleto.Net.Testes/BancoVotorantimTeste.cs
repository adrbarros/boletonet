...
namespace BoletoNet.Testes
{
    ...
    public class BancoVotorantimTeste
    {
        ...
        public BancoVotorantimTeste()
        {
            ...
            //insere testes
            massaTestes.Add(new MassaTestes { Cedente = new MassaTestes.CedenteTeste { Agencia = "0001", ContaCorrente = "0000000400" }, Boleto = new MassaTestes.BoletoTeste { Carteira = "500", Vcto = new DateTime(2027, 8, 18), Valor = 2820.12m, NossoNumero = "0000003158", CodigoBarrasEsperado = "65597190700002820120000000400500000000315800", LinhaDigitavelEsperada = "65590.00002 00400.500005 00003.158003 7 19070000282012" } });
            massaTestes.Add(new MassaTestes { Cedente = new MassaTestes.CedenteTeste { Agencia = "0001", ContaCorrente = "0000000078" }, Boleto = new MassaTestes.BoletoTeste { Carteira = "500", Vcto = new DateTime(2027, 8, 14), Valor = 15.20m, NossoNumero = "0000021226", CodigoBarrasEsperado = "65591190300000015200000000078500000002122600", LinhaDigitavelEsperada = "65590.00002 00078.500006 00021.226006 1 19030000001520" } });
            massaTestes.Add(new MassaTestes { Cedente = new MassaTestes.CedenteTeste { Agencia = "0001", ContaCorrente = "0000000116" }, Boleto = new MassaTestes.BoletoTeste { Carteira = "500", Vcto = new DateTime(2027, 8, 14), Valor = 10.20m, NossoNumero = "0000021226", CodigoBarrasEsperado = "65599190300000010200000000116500000002122600", LinhaDigitavelEsperada = "65590.00002 00116.500000 00021.226006 9 19030000001020" } });
        }
